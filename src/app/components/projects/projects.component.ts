...
export class ProjectsComponent implements OnInit {
  proyectos = [
    ...
    },
    {
      ...
      descripcion: 'Portafolio personal profesional desarrollado en Angular 20 con diseño responsive y animaciones CSS modernas.',
      descripcionCorta: 'Portafolio personal con diseño moderno y responsive',
      imagenes: ['img/MiPortafolio.png', 'img/MiPortafolioMobile.png'],
      link: '#',
      github: 'https://github.com/juliopuntocom/Jose-Julio-Sanchez-Cruzado',
